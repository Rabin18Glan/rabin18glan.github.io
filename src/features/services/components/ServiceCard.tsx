...
function ServiceCard({ title, skills }: ServiceDataProps) {
  ...
  return (
    <Box className='rounded-3xl py-4 w-80 h-auto flex flex-col items-center gap-5 shadow-xl shadow-purple-950 dark:shadow-purple-900 border-2 border-purple-900 dark:border-purple-700'>
